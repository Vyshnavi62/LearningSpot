  ...
  const onFinish = async (values) => {
    try {
      ...
      if (response.success) {
        ...
        if (response.message === "Exam added successfully") {
          message.warning("Please add atleast 5 questions to the exam .")
        }
      ...
      {(examData || !params.id) &&(
        <Form layout="vertical" onFinish={onFinish} initialValues={examData}>
          <Tabs defaultActiveKey="1">
            ...
            >Save</button>
            <button className="secondary-outlined-btn" type="button"
