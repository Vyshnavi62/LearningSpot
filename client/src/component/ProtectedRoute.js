...
function ProtectedRoute({ children }) {
  ...
  const getIsActiveOrNot = (paths) => {
    if (paths.includes(activeRoute)) {
      ...
      if (
        activeRoute.includes("/user/reports/resources") &&
        paths.includes("/user/reports")
      ) {
        return true;
      }
      if (
        activeRoute.includes("/user/tasktimer/settings") &&
        paths.includes("/user/tasktimer")
      ) {
        return true;
      }
    }
